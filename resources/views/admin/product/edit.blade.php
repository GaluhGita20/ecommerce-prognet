        ...
        <div class="row">
          <div class="col-xl-12 col-xxl-12">
            <div class="card">
              ...
              <div class="card-body">
                <form action="{{route('admin.saveEdit.product',$product->id)}}" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label for="product name" class="form-label">Product Name</label>
                        <input type="text" class="form-control" id="product" name="product" value={{$product->product_name}}>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" rows="5" id="description" name="description" required>{{$product->desc}}</textarea>
                    </div>
