...
<div class="modal fade" id="modalAddCart" tabindex="-1" role="dialog" aria-hidden="true">
  ...
  <div class="modal-content">
    <form @if(Auth::guest())   @else action="{{route('cart.add')}}" method="POST" @endif  > 
    @csrf
          ...
          <div class="row">
            ...
            <div class="col-md-6 modal__border">    
              <div class="product-details-box">
                ...
                <div class="product-var p-t-30">
                  <div class="product-quantity product-var__item d-flex align-items-center flex-wrap">
                    ...
                    <form class="modal-quantity-scale m-l-20">
                      ...
                      <input name="qty_product" type="number" class="input_qty_product_cart" id="modal-number">
                ...
                <div class="product-var p-t-30">
                  <div class="product-quantity product-var__item d-flex align-items-center flex-wrap">
                    ...
                    <form class="modal-quantity-scale m-l-20">
                      <input type="text" id="output_subtotal_cart" value="">
                    </form>
                  </div>
                </div>
              </div>        
              ...
              <div class="modal__product-cart-buttons m-tb-15">
                  ...
                  <button @if(Auth::guest()) data-dismiss="modal" data-target="#modalLoginDulu" data-toggle="modal" @else type="submit" @endif  class="btn btn--box  btn--tiny btn--green btn--green-hover-black btn--uppercaset">Add Cart</button>
              </div>
            </div>           
          </div>
        </div>
